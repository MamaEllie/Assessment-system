...
export default function Dashboard() {
  ...
  function generateRecommendations(assessmentResults: any[], score: number) {
    return assessmentResults
      .filter((result) =>
        ["Poor", "Fair", "Inefficiently", "Very inefficiently", "No"].includes(
          result.answer
        )
      )
      .map((result) => `Improve in the area: ${result.question}`);
  }
